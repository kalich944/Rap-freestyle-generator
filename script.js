...
const level4 = {
  subjects: ['Хипстер','Блогер','Олигарх','Путин','Дракон','Баба Яга','Инопланетянин','Ктулху','Шрек','Гарри Поттер','Терминатор','Бэтмен','Дарт Вейдер','Чебурашка','Годзилла','Санта','Иисус'],
